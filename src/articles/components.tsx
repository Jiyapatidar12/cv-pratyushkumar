...
export function ArticleHeader({
  ...
  dateISO,
  readingTime,
  authorName = 'Pratyush Kumar',
  authorUrl,
  authorBio,
  avatarSrc = '/pratyush-avatar.jpg',
  lang,
}: ArticleHeaderProps) {
...
const FOOTER_I18N = {
  ...
  en: {
    role: 'AI Product Manager · Solutions Architect · AI FDE',
    bio: '25+ years of global experience across Banking, Financial Services, IT and Digital Transformation.',
...
export function ArticleFooter({ lang, utmCampaign }: ArticleFooterProps) {
  ...
  const fellowUrl = `https://maven.com/marily-nika/ai-pm-bootcamp?utm_source=pratyush&utm_medium=casestudy&utm_campaign=${utmCampaign}`
  return (
    <footer className="mt-16 pt-8 border-t border-border">
      <div className="flex items-start gap-3 mb-6">
        ...
        />
        <div>
          <p className="font-medium text-foreground">Pratyush Kumar</p>
      ...
      <div className="flex gap-3 mb-8">
        <a href="https://linkedin.com/in/pratyushk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2]/10 border border-[#0A66C2]/20 text-sm font-medium text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-colors">
        ...
        <a href="https://linkedin.com/in/pratyushk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
      ...
      <div className="flex items-center gap-3 text-xs text-muted-foreground">
        <span>&copy; {new Date().getFullYear()} Pratyush Kumar. {f.copyright}</span>
