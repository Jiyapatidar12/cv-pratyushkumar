...
function ReelCard({ reelId, caption }: { reelId: string; caption: string }) {
  return (
    <a
      href={`https://www.instagram.com/pratyush/reel/${reelId}/`}
      target="_blank"
    ...
    >
      <div className="flex items-center gap-2 px-3 py-2.5">
        <div className="w-7 h-7 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-[1.5px] shrink-0">
          <img src="/business-os/ig-avatar.jpg" alt="pratyush" width={100} height={100} className="w-full h-full rounded-full object-cover" />
        </div>
        <p className="text-xs font-semibold text-foreground leading-tight flex-1 min-w-0">pratyush</p>
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <Photo2
        ...
        items={[
          { src: '/business-os/hero-storefront.webp', alt: lang === 'es' ? 'Fachada de pratyush iRepair — tienda de reparación de móviles en Madrid' : 'pratyush iRepair storefront — phone repair shop in Madrid', width: 900, height: 1200 },
          { src: '/business-os/hero-storefront-urban.webp', alt: lang === 'es' ? 'pratyush iRepair de noche — vista urbana con la tienda iluminada' : 'pratyush iRepair at night — urban view with the shop lit up', width: 800, height: 1067 },
        ]}
        className="mb-8"
      />
      ...
      <article className="prose-custom">
        ...
        <Photo2
          ...
          items={[
            { src: '/business-os/counter-organized-front.webp', alt: lang === 'es' ? 'Interior de pratyush iRepair — lo que ve el cliente al entrar: mostrador con iMac, logo y lámpara esférica' : 'pratyush iRepair interior — what the customer sees walking in: counter with iMac, logo and spherical lamp', width: 360, height: 480 },
            { src: '/business-os/after-elevator-lamp.webp', alt: lang === 'es' ? 'Montacargas de madera junto a lámpara esférica y logo pratyush — conexión entre mostrador y taller' : 'Wooden dumbwaiter next to spherical lamp and pratyush logo — connection between counter and workshop', width: 360, height: 480 },
          ]}
            ...
            <div key={flow.name} className="scroll-mt-20">
              ...
              {idx === 0 && (
                <Photo2 editorId="repair-counter-watch"
                  items={[
                    { src: '/business-os/after-counter-pov.webp', alt: lang === 'es' ? 'Mostrador de pratyush desde el punto de vista del empleado — iMac con Airtable abierto, citas programadas' : 'pratyush counter from employee POV — iMac with Airtable open, appointments scheduled', width: 800, height: 1067 },
                      ...
                      <div className="bg-background/50 rounded-lg border border-border p-4">
                        ...
                        <div className="bg-primary/5 border-l-2 border-primary/30 pl-3 py-2">
                          <p className="text-xs text-muted-foreground mb-1 font-medium">
                            {lang === 'es' ? 'Respuesta de pratyush iRepair:' : 'pratyush iRepair response:'}
                          </p>
        ...
        <CaseStudyCta
          ...
          ctaHref={lang === 'es' ? 'mailto:pratyush@prabisha.com?subject=Programmatic SEO' : 'mailto:pratyush@prabisha.com?subject=Programmatic SEO'}
        />
        ...
        <Photo2
          ...
          items={[
            { src: '/business-os/after-store-interior.webp', alt: lang === 'es' ? 'Interior de pratyush iRepair' : 'pratyush iRepair interior', width: 1200, height: 900 },
        ...
        <CaseStudyCta
          ...
          ctaHref="mailto:pratyush@prabisha.com?subject=Business OS Architecture"
        />
